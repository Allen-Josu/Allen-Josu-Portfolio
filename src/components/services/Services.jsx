    ...
    <section className="services section" id="services">
      ...
      <div className="services__container container grid">
        <div className="services__content">
          ...
          <div className={toogleState===1? "services__modal active-modal" 
          : "services__modal"}>
        ...
        <div className="services__content">
          ...
          <div className={toogleState===2? "services__modal active-modal" 
          : "services__modal"}>
            <div className="services__modal-content">
              <i onClick={() => toogleTab(0)} className="uil uil-times services__modal-close"></i>
        ...
        <div className="services__content">
          ...
          <div className={toogleState===3? "services__modal active-modal" 
          : "services__modal"}>
            <div className="services__modal-content">
              <i  onClick={() => toogleTab(0)} className="uil uil-times services__modal-close"></i>
